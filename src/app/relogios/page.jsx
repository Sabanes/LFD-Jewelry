...
export default function Marcas() {
  ...
  useEffect(() => {
    const hasReloaded = sessionStorage.getItem('watches-page-reloaded');
    if (!hasReloaded) {
      sessionStorage.setItem('watches-page-reloaded', 'true');
  ...
  useEffect(() => {
    ...
    }, 200); // Slightly longer delay for watches page
